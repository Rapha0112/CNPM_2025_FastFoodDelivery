...
namespace Business_Layer.Migrations
{
    ...
    [Migration("20251125024220_RemoveShipperColumn")]
    partial class RemoveShipperColumn
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data_Layer.Models.Drone", b =>
                {
            ...
            modelBuilder.Entity("Data_Layer.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("OrderDate")
                        ...
                        .HasDefaultValue(new DateTime(2025, 11, 25, 9, 42, 20, 907, DateTimeKind.Local).AddTicks(101));

                    b.Property<DateTime?>("RequiredDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 11, 28, 9, 42, 20, 907, DateTimeKind.Local).AddTicks(323));
                    ...
                    b.Property<DateTime?>("ShippedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 11, 30, 9, 42, 20, 907, DateTimeKind.Local).AddTicks(408));
            ...
            modelBuilder.Entity("Data_Layer.Models.Drone", b =>
                {
                    b.HasOne("Data_Layer.Models.Order", "CurrentOrder")
                        .WithMany()
            ...
            modelBuilder.Entity("Data_Layer.Models.Order", b =>
                {
                    b.HasOne("Data_Layer.Models.Drone", "Drone")
                        .WithMany()
