...
function Report() {
  ...
  const fetchFood = async () => {
    try {
      const response = await axios.get(
        "http://localhost:5213/api/AdminDashboard/dashboard/total-food-menu"
      );
  ...
  const fetchCategories = async () => {
    try {
      const response = await axios.get(
        "http://localhost:5213/api/AdminDashboard/dashboard/total-categories"
      );
      console.log(response.data);
  ...
  const fetchChart = async () => {
    try {
      const response = await axios.get(
        "http://localhost:5213/api/AdminDashboard/GetTopFiveCustomer"
      );
      console.log(response.data);
  ...
  const fetchOrder = async () => {
    try {
      const response = await axios.get(
        "http://localhost:5213/api/AdminDashboard/dashboard/total-orders"
      );
      console.log(response.data);
  ...
  const fetchUser = async () => {
    try {
      const response = await axios.get(
        "http://localhost:5213/api/AdminDashboard/dashboard/active-user"
      );
      console.log(response.data);
