...
function Category() {
  ...
  const handleDeleteCategory = async (categoryId) => {
    ...
    await axios.delete(
      `http://localhost:5213/api/Category/DeleteCategory/${categoryId}`
    );
  ...
  async function handleSubmit(values) {
    ...
    const response = await axios.post(
      "http://localhost:5213/api/Category/CreateCategory",
      values
    );
  ...
  async function handleEditCategory(value) {
    ...
    axios
      .put(`http://localhost:5213/api/Category/UpdateCategory/${idCategory}`, {
